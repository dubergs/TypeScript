...
let num2:number = 10 // Se define tipo de dato
...
//Array
function poderes(){
    const poderes:string[] = ["Fuego", "Rayo", "Trueno"]
    poderes.push("Agua")
    console.log(poderes)
}
